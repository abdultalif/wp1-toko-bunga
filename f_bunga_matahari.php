  ...
  <div class="container">
    ...
    <form action="print.php" method="post">
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="nama" placeholder="Masukan Nama" autocomplete="" required="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" name="bunga" value="Bunga Matahari" readonly="">
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="number" name="harga" id="harga" value="20000" readonly="">
        </div>
      </div>
